...
class ArtCulture extends StatefulWidget {
  const ArtCulture({super.key});

  @override
  State<ArtCulture> createState() => _ArtCultureState();
}

class _ArtCultureState extends State<ArtCulture> {
  @override
